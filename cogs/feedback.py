    ...
    async def send_ticket_feedback_callback(self, ctx: discord.ApplicationContext):
        ...
        for member in users_with_role:
            ...
            feedback_embed = discord.Embed(
                ...
                description=f"You've been invited to participate in a volunteer survey about the <@1216023200673042503> bot ticket system. Your feedback is invaluable in helping us enhance our system and provide you with even better service. We greatly appreciate your time and input!\n\nYou Discord ID is `{member.id}`",
